{% tabs %}{% tab title='BJ_5430.md' %}

* Function R is a function that reverses order of numbers in array, and D is function that throws away the first number
