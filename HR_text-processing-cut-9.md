{% tabs %}{% tab title='HR_text-processing-cut-9.md' %}

* Given a tab delimited file with several columns (tsv format) print the fields from second fields to last field

```txt
Input:
1   New York-Northern New Jersey-Long Island, NY-NJ-PA MSA  19,015,900  1   New York-Newark, NY-NJ-CT-PA CSA 22,214,083
...
Output:
New York-Northern New Jersey-Long Island, NY-NJ-PA MSA  19,015,900  1   New York-Newark, NY-NJ-CT-PA CSA 22,214,083
...
{% endtab %}{% tab title='HR_text-processing-cut-9.sh' %}
